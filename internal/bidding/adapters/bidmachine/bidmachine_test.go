...
func TestBidmachine_CreateRequest(t *testing.T) {
	...
	for _, tC := range testCases {
		...
		if diff := cmp.Diff(tC.want, got, cmp.Comparer(compareErrors), cmpopts.IgnoreFields(adapters.DemandBid{}, "Ext", "Rendering")); diff != "" {
...
func TestBidmachineAdapter_ExecuteRequest(t *testing.T) {
	...
	response := adapters.ExecuteDemandRequest(context.Background(), customClient, &networkAdapter, request, adapter.BidmachineKey)
