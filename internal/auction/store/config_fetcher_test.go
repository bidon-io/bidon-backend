	...
	testCases := []struct {
	...
	}{
		{
			...
			want: &auction.Config{
				...
				Bidding:   db.StringArrayToAdapterKeys(&app1BannerConfig.Biddings),
		...
		},
		{
			...
			want: &auction.Config{
				...
				Bidding:   db.StringArrayToAdapterKeys(&app2BannerConfig.Biddings),
		...
		},
		{
			...
			want: &auction.Config{
				...
				Bidding:   db.StringArrayToAdapterKeys(&app2InterstitialConfig.Biddings),
		...
		},
		{
			...
			want: &auction.Config{
				...
				Bidding:   db.StringArrayToAdapterKeys(&app3InterstitialConfig.Biddings),
	...
	testCases := []struct {
		...
		},
		{
			...
			want: &auction.Config{
				...
				Bidding:   db.StringArrayToAdapterKeys(&latestConfig.Biddings),
