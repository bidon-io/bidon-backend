docker-build-prod-api:
	...
	cd bidon_api && docker buildx build --platform linux/amd64,linux/arm64 --target=prod -t registry.appodeal.com/bidon/api:$(TAG) -t registry.appodeal.com/bidon/api:latest -t ghcr.io/bidon-io/bidon-api:latest -t ghcr.io/bidon-io/bidon-api:$(TAG) .
